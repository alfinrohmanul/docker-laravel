...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-user-tie nav-icon"></i> Buat Supplier</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                ...
                                @endif
                                <form action="SimpanSupp" method="post">
                                    {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" placeholder="No.Item" autocomplete="off" name="no_supp" value="{{$counter}}" readonly>
                                            @if($errors->has('no_supp'))
                                            <div class="text-danger">{{ $errors->first('no_supp') }}</div>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                            <label for="nabar">Nama Supplier</label>
                                            <input class="form-control form-control-sm" type="text" placeholder="Nama Supplier..." autocomplete="off" name="nama_supp" value="{{old('nama_supp')}}">
                                            @if($errors->has('nama_supp'))
                                            <div class="text-danger">{{ $errors->first('nama_supp') }}</div>
                                            @endif
                                        </div>
                                        <div class="form-group">
                                            <label for="sabar">No Telp</label>
                                            <input class="form-control form-control-sm" type="text" placeholder="No Telp..." autocomplete="off" name="no_telp" value="{{old('no_telp')}}">
