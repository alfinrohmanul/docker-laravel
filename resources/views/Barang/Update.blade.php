...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-cube nav-icon"></i> Edit Item</h1>
    ...
    <section class="content">
        <div class="container-fluid">
        <form action="{{url('Barang/SaveB')}}" method="POST" id="form-barang">
        {{ csrf_field() }}
            <!-- Main row -->
            <div class="row">
                <!-- Live -->
                    ...
                    <div class="card card-danger card-outline">
                            <div class="card-body">
                              <div class="col-sm-6 col-12">
                                    <input class="form-control form-control-sm" type="text" placeholder="No.Barang" autocomplete="off" name="kode_barang" value="{{$barang->kode_barang}}" hidden>
                                            <div class="form-group">
                                                <label for="nabar">Nama Barang</label>
                                                <input class="form-control form-control-sm" type="text" placeholder="Nama Barang" autocomplete="off" name="nama_barang" value="{{$barang->nama_barang}}">
                                            </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                <label for="groping">Group</label>
                                                <select class="form-control select2" name="grouping">
                                               
                                                  @foreach($group as $grp)
                                                    @if($barang->kategori==$grp->numberof)
                                                      <option value="{{$grp->numberof}}" dumpy="{{$grp->id}}" selected>{{$grp->kategori}}</option>
                                                      @else
                                            ...
                                            <div class="form-group">
                                              ...
                                              <option value="{{$barang->itemfor}}">{{$barang->itemfor}}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm" type="text" placeholder="Barcode" autocomplete="off" name="barcode" value="{{$barang->barcode}}">
                                            </div>
                                            </div>
                            ...
                            <div class="card-body">
                              <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm text-right nominal" type="text" autocomplete="off" name="hpp_barang" value="{{rupiah($barang->hpp_barang)}}">
                                            </div>
                                            <!-- <div class="form-group">
                                                <label for="no_barang">Harga Beli</label>
                                                <input class="form-control form-control-sm text-right nominal" type="text" autocomplete="off" name="harga1" value="{{rupiah($barang->harga)}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="nabar">Harga Jual</label>
                                                <input class="form-control form-control-sm text-right nominal" type="text" autocomplete="off" name="harga2" value="{{rupiah($barang->harga1)}}">
                                            </div> -->
                                            <div class="form-group">
                                                <label for="margin">Margin %</label>
                                                <input class="form-control form-control-sm text-right" type="text" autocomplete="off" name="marginset" value="{{$barang->marginset}}">
                                            </div>
                              </div>
                            </div>
                    </div>
                          ...
                          <div class="card-body">
                              <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm" type="text" placeholder="Satuan 1" autocomplete="off" name="satuan1" value="{{$barang->satuan}}">
                                           
                                            </div>
                                            <div class="form-group">
                                                <label for="nabar">Satuan 2</label>
                                                <input class="form-control form-control-sm" type="text" placeholder="Satuan 2" autocomplete="off" name="satuan2" value="{{$barang->satuan1}}">
                          ...
                          <div class="card-body">
                              <div class="col-lg-6 col-12" >
                                <div class="form-group" id="groupakun">
                                  ...
                                  <select class="form-control form-control-sm" style="width: 100%;" id="akun1" name="kodeakun1">
                                    @foreach($akun as $k)
                                          <?php 
                                                    if($k->is_header=="Y"){
                                                        $var="disabled";
                                                    ...
                                                    ?>
                                                     @if($barang->kode_akun1==$k->kode_akun)
                                                     <option <?=$var?> value="{{$k->kode_akun}}" selected><?=$dump?></option>
                                                    @else
                                  ...
                                  <div class="form-group" id="groupakun">
                                    ...
                                    @foreach($akun as $k)
                                          <?php 
                                                    ...
                                                    ?>
                                     @if($barang->kode_akun2==$k->kode_akun)
                                                     <option <?=$var?> value="{{$k->kode_akun}}" selected><?=$dump?></option>
                                                    @else
                                                    <option <?=$var?> value="{{$k->kode_akun}}"><?=$dump?></option>
                                                  @endif
