...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <h1 class="m-0 text-dark"><i class="fas fa-list nav-icon"></i> List Belum diambil</h1>
            @else
            <h1 class="m-0 text-dark"><i class="fas fa-list nav-icon"></i> List Sudah diambil</h1>
            @endif
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
var tabel = null;
    $(document).ready(function() {
        tabel = $('#example1').DataTable({
            ...
            "ajax":
            {
                "url": "{{ url('Penjualan/ListTransaksi')}}/{{ Request::segment(3) }}", // URL file untuk proses select datanya
            },
            "deferRender": true,
