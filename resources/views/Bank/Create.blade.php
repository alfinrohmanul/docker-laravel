...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-university nav-icon"></i> Buat Bank</h1>
                            ...
                            <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input class="form-control form-control-sm" type="text" placeholder="Nama Bank" autocomplete="off" name="nama_bank">
                                        </div>
                                        <div class="form-group">
                                            <label for="nabar">No Rekening</label>
                                            <input class="form-control form-control-sm" type="text" placeholder="No rekening..." autocomplete="off" name="no_rekening">
                                        </div>
                                    </div>
